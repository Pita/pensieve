...
exports.from_base64 = function (input) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, libsodium_wrappers_1.default.ready];
            case 1:
                _a.sent();
                return [2 /*return*/, libsodium_wrappers_1.default.from_base64(input)];
        }
    });
}); };
exports.to_base64 = function (input) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, libsodium_wrappers_1.default.ready];
            case 1:
                _a.sent();
                return [2 /*return*/, libsodium_wrappers_1.default.to_base64(input)];
        }
    });
}); };
